...
def create_cls_model(num_labels):
    ...
    bilstm = Bidirectional(LSTM(128, return_sequences=True), merge_mode='concat')(cls_layer)
    atten = AttentionLayer(attention_size=256)(bilstm)

    p = Dense(num_labels, activation='sigmoid')(atten)  # 多分类
